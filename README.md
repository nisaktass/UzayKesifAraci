...
## 🚀 Proje İçeriği
`src` klasörü içerisinde yer alan temel yapılar:
* **Gezegenler & Kara Delikler:** Farklı kütle ve özelliklere sahip kozmik cisimlerin (`A1`, `B1`, `C1` gezegenleri ve `Karadelik` sınıfları) modellenmesi.
